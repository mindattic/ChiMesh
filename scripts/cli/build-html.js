#!/usr/bin/env node
/*
 * build-html.js — render ChiMesh.md to a self-contained ChiMesh.htm.
 *
...
function pickSource() {
    ...
    // so links to /ChiMesh.htm always resolve to the latest revision.
    const p = path.join(repoRoot, 'ChiMesh.md');
    if (!fs.existsSync(p)) throw new Error('ChiMesh.md not found in ' + repoRoot);
    return p;
}
...
<meta name="generator" content="ChiMesh build-html.js — generated from ${escapeHtml(sourceName)}">
<title>${escapeHtml(title)}</title>
<style>
/* == BEGIN MINDATTIC.CONTENT:OUTFITFONT.CSS == */
/* Generated by MindAttic.Content/sync/sync-chimesh.ps1. Do not edit by hand.
   Edit the MindAttic.Content source folder and re-run the sync. */
@font-face {
  font-family: 'Outfit';
  font-style: normal;
  font-weight: 100 900;
...
/* == END MINDATTIC.CONTENT:OUTFITFONT.CSS == */

/* == BEGIN MINDATTIC.CONTENT:ATTICFONT.CSS == */
/* Generated by MindAttic.Content/sync/sync-chimesh.ps1. Do not edit by hand.
   Edit the MindAttic.Content source folder and re-run the sync. */
@font-face {
  font-family: 'Attic';
...
/* applyToSelector for this consumer */
#chimesh { font-family: 'Attic', serif; }

/* == END MINDATTIC.CONTENT:ATTICFONT.CSS == */
...
(function () {
  ...
  var saved = null;
  try { saved = localStorage.getItem('chimesh-theme'); } catch (_) {}
  if (saved !== 'dark' && saved !== 'light') {
    saved = 'dark';
    try { localStorage.setItem('chimesh-theme', 'dark'); } catch (_) {}
  }
  ...
  btn.addEventListener('click', function () {
    ...
    setBtnIcon(dark);
    try { localStorage.setItem('chimesh-theme', dark ? 'dark' : 'light'); } catch (_) {}
  });
}());

// ───────── Build configurator ─────────
// Each <select data-config="KEY"> drives a localStorage entry under
// "chimesh-build-config". Any element with class "when" and one or more
...
(function () {
  ...
  var SAVED_KEY = 'chimesh-build-config';
