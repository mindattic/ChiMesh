#!/bin/bash
# install-chimesh.sh — automate Parts 4 through 9 of the build guide.
#
# Run this on the Pi after a fresh Raspberry Pi OS 64-bit boot:
#     scp scripts/pi/install-chimesh.sh pi@chimesh.local:~
#     ssh pi@chimesh.local 'bash ~/install-chimesh.sh'
#
