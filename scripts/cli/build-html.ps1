<#
.SYNOPSIS
    Render ChiMesh.md to a self-contained ChiMesh.htm.
...
.PARAMETER Source
    Optional path to a specific .md. Defaults to ChiMesh.md in the repo root.
#>
[CmdletBinding()]
param(
    [string]$Source
...
if (-not (Get-Command node -ErrorAction SilentlyContinue)) {
    Write-Error "Node.js not found on PATH. Install from https://nodejs.org, then run ChiMesh.Console update."
}
